...
<div class="row align-items-center mt-0 mobile-column-reverse mt-5">
    ...
    <div class="col-lg-6 col-md-12 col-sm-12 col-12 txt-top content-txt ">
        ...
        <div class="content-txt-div mt-4">
            星際種子學院是一個分享星界奧秘知識和幫助人「憶起」內在神聖的地方。這裡是引導每一個靈魂回家的道路；在這裡，你會更深入認識身心靈的世界，並且在這個世界盡情發光發亮！我們的靈魂來到地球，所渴望的就是體驗完滿的生命。而現在，在這裡，你將會可以在你的靈性修行上更進一步，讓你的療癒、冥想、學習、知識全都進入另一個世界。在這裡，你將會接受成為星界療癒師所需要的訓練和教育。我們除了提供教授各種靈性技術的課程和工作坊外，也創立了「揚升聖殿」，一個長期讓大家吸收奧秘知識、下載能量和讓宇宙的頻率融入自己生活的學習平台，讓大家的學習不會因為課程或工作坊的時數而受限制，可以定期吸收新知識和接受提升。
        </div>
